================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Demo2 Project Overview
===============================================================================

The application wizard has created this Demo2 application for
...
Demo2Dlg.h, Demo2Dlg.cpp - the dialog
    ...
    in Demo2.rc, which can be edited in Microsoft Visual C++.
